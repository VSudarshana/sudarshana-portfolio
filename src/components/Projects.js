...
const Projects = ({
  ...
  return (
    <div className="flex flex-col md:flex-row gap-12 px-5 items-center bg-white py-6 rounded-lg shadow-[10px_10px_60px_-15px_rgba(0,0,0,0.3)]">
      <a
        className="lg:w-1/2"
        href={webUrl}
      ...
      <div className="lg:w-1/2">
        ...
        <div className="flex flex-row justify-center gap-6 text-lg">
          <a href={githubCode} rel="external noreferrer" target="_blank">
            <h1 className="flex justify-center items-center  duration-200 hover:text-cyan-700 gap-1 mt-5 font-semibold">
              Code
          ...
          <a href={webUrl} rel="external noreferrer" target="_blank">
            <h1 className="flex justify-center items-center duration-200 hover:text-fuchsia-800  gap-1 mt-5 font-semibold">
              Live Demo
